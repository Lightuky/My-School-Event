...
<div class="row m-0">
    ...
    <section>
    <div class="m-button-menu-friends">
    ...
    <section class="col-10 mx-0 p-0 d-flex ml-auto" style="margin-top: 60px">
        <div class="flex-row m-auto mt-3">
            <h1 class="mt-3">Mes amis</h1>
            <form class="form-inline" method="post" action="assets/friendssearch.php">
            ...
            <div class="card mb-3" style="max-width: 540px;">
                <div class="row no-gutters">
                    <div class="col-md-4">
                        <img src="https://www.gravatar.com/avatar/<?php echo md5($friends_credential['email']); ?>?s=700" alt="" class="d-block rounded-circle " id="ContentProfilePics">
                    </div>
                    <div class="col-md-5">
                        <div class="card-body">
                            <h5 class="card-title">
                                ...
                                <?php echo $friends_credential["pending"] ?>
                    ...
                    <div class="col-md-3">
                        <?php if ($friends_credential['pending'] === '2'): ?>
                            <div class="d-flex mb-2">
                                <div class="btn bg-secondary text-white">Amis</div>
                            </div>
